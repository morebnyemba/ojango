      ...
      <div className="container mx-auto px-6 max-w-6xl">
        ...
        <div className="grid md:grid-cols-3 gap-8">
          {stakeholders.map((stakeholder, index) => (
            ...
            >
              <div className="relative p-8 rounded-2xl bg-gradient-to-br from-gray-50 to-white border border-gray-200 group-hover:shadow-2xl group-hover:shadow-gray-200/50 transition-all duration-300 h-full">
