    ...
    <section className="py-20 bg-gradient-to-br from-gray-900 to-black text-white relative overflow-hidden">
      ...
      <div className="container mx-auto px-6 max-w-4xl relative z-10">
        <div className="text-center">
          ...
          <motion.div 
            className="w-32 h-32 mx-auto mb-8 rounded-full border-4 border-white/20 flex items-center justify-center relative"
          ...
          >
            ...
            >
              <div className="w-16 h-16 rounded-full bg-white/10 flex items-center justify-center">
                <span className="text-white font-bold text-sm">OJANGO</span>
              </div>
            </motion.div>
          </motion.div>
          ...
          <motion.div 
            className="text-2xl font-light text-gray-200 space-y-4"
            initial={{ opacity: 0, y: 30 }}
            whileInView={{ opacity: 1, y: 0 }}
